...
;*******************************************************************************
    ...
    bsf OSCCON, 6 ; ((OSCCON) and 07Fh), 6 en 1
    bcf OSCCON, 5 ; ((OSCCON) and 07Fh), 5 en 0
    bsf OSCCON, 4 ; ((OSCCON) and 07Fh), 4 en 1
...
;*******************************************************************************
    ...
    bsf TRISA, 0 ; Se configura el pin ((PORTA) and 07Fh), 0 como un input
    bsf TRISA, 1 ; Se configura el pin ((PORTA) and 07Fh), 1 como un input
...
LOOP:
    ...
    bcf INTCON, 2 ; Si está en 1 se borra la bandera del ((INTCON) and 07Fh), 2
    movlw 61 ; Se carga 61 a W
